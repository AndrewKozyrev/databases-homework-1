...
VALUES ('Beyoncé', 'USA');
INSERT INTO student09.artists (name, country)
VALUES ('Kanye West', 'USA');
INSERT INTO student09.artists (name, country)
VALUES ('Miles Davis', 'USA');
INSERT INTO student09.artists (name, country)
VALUES ('Ludwig van Beethoven', 'Germany');

-- Наполнение таблицы с альбомами
INSERT INTO student09.albums (artist_id, title, release_year)
VALUES ((SELECT artist_id FROM student09.artists WHERE name = 'The Beatles'),
        'Abbey Road',
        1969);

INSERT INTO student09.albums (artist_id, title, release_year)
VALUES ((SELECT artist_id FROM student09.artists WHERE name = 'Beyoncé'),
        'Lemonade',
        2016);

INSERT INTO student09.albums (artist_id, title, release_year)
VALUES ((SELECT artist_id FROM student09.artists WHERE name = 'Kanye West'),
        'My Beautiful Dark Twisted Fantasy',
        2010);

INSERT INTO student09.albums (artist_id, title, release_year)
VALUES ((SELECT artist_id FROM student09.artists WHERE name = 'Miles Davis'),
        'Kind of Blue',
        1959);

INSERT INTO student09.albums (artist_id, title, release_year)
VALUES ((SELECT artist_id FROM student09.artists WHERE name = 'Ludwig van Beethoven'),
        'Symphony No. 9',
        1824);

-- Наполнение таблицы с треками
INSERT INTO student09.tracks (album_id, artist_id, title, release_year, duration, play_count)
VALUES ((SELECT album_id FROM student09.albums WHERE title = 'Abbey Road'),
...
INSERT INTO student09.tracks (album_id, artist_id, title, release_year, duration, play_count)
VALUES ((SELECT album_id FROM student09.albums WHERE title = 'Lemonade'),
...
INSERT INTO student09.tracks (album_id, artist_id, title, release_year, duration, play_count)
VALUES ((SELECT album_id FROM student09.albums WHERE title = 'My Beautiful Dark Twisted Fantasy'),
...
INSERT INTO student09.tracks (album_id, artist_id, title, release_year, duration, play_count)
VALUES ((SELECT album_id FROM student09.albums WHERE title = 'Kind of Blue'),
...
INSERT INTO student09.tracks (album_id, artist_id, title, release_year, duration, play_count)
VALUES ((SELECT album_id FROM student09.albums WHERE title = 'Symphony No. 9'),
...
VALUES ((SELECT track_id FROM student09.tracks WHERE title = 'Come Together'),
        (SELECT genre_id FROM student09.genres WHERE genre_name = 'Rock'));

INSERT INTO student09.track_genres (track_id, genre_id)
VALUES ((SELECT track_id FROM student09.tracks WHERE title = 'Formation'),
        (SELECT genre_id FROM student09.genres WHERE genre_name = 'Pop'));

INSERT INTO student09.track_genres (track_id, genre_id)
VALUES ((SELECT track_id FROM student09.tracks WHERE title = 'Power'),
        (SELECT genre_id FROM student09.genres WHERE genre_name = 'Hip-Hop'));

INSERT INTO student09.track_genres (track_id, genre_id)
VALUES ((SELECT track_id FROM student09.tracks WHERE title = 'So What'),
        (SELECT genre_id FROM student09.genres WHERE genre_name = 'Jazz'));

INSERT INTO student09.track_genres (track_id, genre_id)
VALUES ((SELECT track_id FROM student09.tracks WHERE title = 'Ode to Joy'),
